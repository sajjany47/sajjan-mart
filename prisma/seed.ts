...
async function main() {
  ...
  // Food products
  const foodProducts = [
    { name: 'Margherita Pizza', slug: 'margherita-pizza', description: 'Classic pizza with fresh mozzarella, basil and tomato sauce', categoryId: food.id, subCategoryId: pizza.id, brandId: sajjanKitchen.id, productType: 'food', productCategory: 'pizza', purchasePrice: 149.4, salesPrice: 249, foodType: 'veg', discountPercent: 10, rating: 4.5, reviewCount: 128, isFeatured: true, isBestSeller: true, isPopular: true, isTodayDeal: true, metadata: { ingredients: ['mozzarella', 'basil', 'tomato sauce'], prepTime: '20 min', veg: true } },
    { name: 'Chicken Tikka Pizza', slug: 'chicken-tikka-pizza', description: 'Tandoori chicken tikka with onions, capsicum and mint mayo', categoryId: food.id, subCategoryId: pizza.id, brandId: sajjanKitchen.id, productType: 'food', productCategory: 'pizza', purchasePrice: 209.4, salesPrice: 349, foodType: 'non_veg', discountPercent: 15, rating: 4.7, reviewCount: 96, isFeatured: true, isBestSeller: true, isPopular: true, metadata: { ingredients: ['chicken tikka', 'onion', 'capsicum'], prepTime: '25 min', veg: false } },
    { name: 'Classic Veg Burger', slug: 'classic-veg-burger', description: 'Crispy patty with cheese, lettuce and tomato', categoryId: food.id, subCategoryId: burger.id, brandId: sajjanKitchen.id, productType: 'food', productCategory: 'burger', purchasePrice: 77.4, salesPrice: 129, foodType: 'veg', rating: 4.3, reviewCount: 210, isBestSeller: true, isPopular: true, isTodayDeal: true, metadata: { ingredients: ['veg patty', 'cheese', 'lettuce'], prepTime: '15 min', veg: true } },
    { name: 'Steamed Veg Momos', slug: 'steamed-veg-momos', description: '8 pieces of steamed dumplings with spicy chutney', categoryId: food.id, subCategoryId: momos.id, brandId: sajjanKitchen.id, productType: 'food', productCategory: 'momos', purchasePrice: 59.4, salesPrice: 99, foodType: 'veg', rating: 4.6, reviewCount: 320, isFeatured: true, isBestSeller: true, isPopular: true, metadata: { ingredients: ['flour', 'cabbage', 'carrot'], prepTime: '18 min', veg: true } },
    { name: 'Chicken Biryani', slug: 'chicken-biryani', description: 'Fragrant basmati rice with marinated chicken and aromatic spices', categoryId: food.id, subCategoryId: biryani.id, brandId: sajjanKitchen.id, productType: 'food', productCategory: 'biryani', purchasePrice: 137.4, salesPrice: 229, foodType: 'non_veg', discountPercent: 12, rating: 4.8, reviewCount: 410, isFeatured: true, isBestSeller: true, isPopular: true, isTodayDeal: true, metadata: { ingredients: ['basmati rice', 'chicken', 'saffron'], prepTime: '30 min', veg: false } },
    { name: 'Chicken Popcorn', slug: 'chicken-popcorn', description: 'Bite-sized crispy chicken pieces with dip', categoryId: food.id, subCategoryId: rolls.id, brandId: sajjanKitchen.id, productType: 'food', productCategory: 'rolls_wraps', purchasePrice: 107.4, salesPrice: 179, foodType: 'non_veg', rating: 4.4, reviewCount: 88, isPopular: true, metadata: { ingredients: ['chicken', 'flour', 'spices'], prepTime: '12 min', veg: false } },
    { name: 'Paneer Roll', slug: 'paneer-roll', description: 'Tandoori paneer wrapped in soft roti with mint chutney', categoryId: food.id, subCategoryId: rolls.id, brandId: sajjanKitchen.id, productType: 'food', productCategory: 'rolls_wraps', purchasePrice: 89.4, salesPrice: 149, foodType: 'veg', rating: 4.5, reviewCount: 142, isBestSeller: true, isPopular: true, metadata: { ingredients: ['paneer', 'roti', 'onion'], prepTime: '10 min', veg: true } },
    { name: 'French Fries', slug: 'french-fries', description: 'Crispy golden fries with peri peri seasoning', categoryId: food.id, subCategoryId: rolls.id, brandId: sajjanKitchen.id, productType: 'food', productCategory: 'snacks', purchasePrice: 53.4, salesPrice: 89, foodType: 'veg', rating: 4.2, reviewCount: 180, isBestSeller: true, isPopular: true, isTodayDeal: true, metadata: { ingredients: ['potato', 'peri peri'], prepTime: '8 min', veg: true } },
    { name: 'Cold Coffee', slug: 'cold-coffee', description: 'Chilled creamy coffee with ice cream', categoryId: food.id, subCategoryId: beverages.id, brandId: sajjanKitchen.id, productType: 'food', productCategory: 'beverages', purchasePrice: 71.4, salesPrice: 119, foodType: 'veg', rating: 4.6, reviewCount: 75, isPopular: true, metadata: { ingredients: ['coffee', 'milk', 'ice cream'], prepTime: '5 min', veg: true } },
  ];
  ...
  const naturalProducts = [
    { name: 'Cold Pressed Mustard Oil', slug: 'cold-pressed-mustard-oil', description: 'Traditional wood-pressed mustard oil from organic seeds', categoryId: natural.id, subCategoryId: oils.id, brandId: farmFresh.id, productType: 'natural', productCategory: 'oil_ghee', purchasePrice: 192, salesPrice: 320, quantityType: 'pack', discountPercent: 5, rating: 4.7, reviewCount: 64, isFeatured: true, isBestSeller: true, isPopular: true },
    { name: 'Organic Turmeric Powder', slug: 'organic-turmeric-powder', description: 'High-curcumin turmeric, sun-dried and stone-ground', categoryId: natural.id, subCategoryId: spices.id, brandId: pureOrganic.id, productType: 'natural', productCategory: 'masala_spices', purchasePrice: 108, salesPrice: 180, quantityType: 'pack', rating: 4.8, reviewCount: 92, isFeatured: true, isBestSeller: true, isPopular: true, isTodayDeal: true },
    { name: 'Premium Basmati Rice', slug: 'premium-basmati-rice', description: 'Aged 2-year basmati from the foothills of Himalayas', categoryId: natural.id, subCategoryId: grains.id, brandId: farmFresh.id, productType: 'natural', productCategory: 'grains_rice', purchasePrice: 270, salesPrice: 450, quantityType: 'pack', discountPercent: 8, rating: 4.6, reviewCount: 48, isFeatured: true, isBestSeller: true, isPopular: true },
    { name: 'Whole Wheat Atta', slug: 'whole-wheat-atta', description: 'Stone-ground wheat flour from MP Sharbati wheat', categoryId: natural.id, subCategoryId: grains.id, brandId: farmFresh.id, productType: 'natural', productCategory: 'grains_rice', purchasePrice: 144, salesPrice: 240, quantityType: 'pack', rating: 4.5, reviewCount: 56, isBestSeller: true, isPopular: true },
    { name: 'Raw Forest Honey', slug: 'raw-forest-honey', description: 'Multi-floral raw honey harvested by tribal communities', categoryId: natural.id, subCategoryId: honeyGhee.id, brandId: pureOrganic.id, productType: 'natural', productCategory: 'honey_jaggery', purchasePrice: 228, salesPrice: 380, quantityType: 'pack', discountPercent: 10, rating: 4.9, reviewCount: 110, isFeatured: true, isBestSeller: true, isPopular: true, isTodayDeal: true },
    { name: 'A2 Desi Cow Ghee', slug: 'a2-desi-cow-ghee', description: 'Bilona method ghee from grass-fed Gir cows', categoryId: natural.id, subCategoryId: honeyGhee.id, brandId: pureOrganic.id, productType: 'natural', productCategory: 'oil_ghee', purchasePrice: 534, salesPrice: 890, quantityType: 'pack', discountPercent: 5, rating: 4.9, reviewCount: 78, isFeatured: true, isBestSeller: true, isPopular: true },
    { name: 'Organic Toor Dal', slug: 'organic-toor-dal', description: 'Unpolished toor dal, rich in protein', categoryId: natural.id, subCategoryId: grains.id, brandId: farmFresh.id, productType: 'natural', productCategory: 'dal_legumes', purchasePrice: 96, salesPrice: 160, quantityType: 'pack', rating: 4.4, reviewCount: 36, isPopular: true },
    { name: 'Whole Spices Combo', slug: 'whole-spices-combo', description: 'Mixed whole spices - cardamom, clove, cinnamon, bay leaf', categoryId: natural.id, subCategoryId: spices.id, brandId: pureOrganic.id, productType: 'natural', productCategory: 'masala_spices', purchasePrice: 312, salesPrice: 520, quantityType: 'pack', discountPercent: 12, rating: 4.7, reviewCount: 44, isFeatured: true, isBestSeller: true, isPopular: true, isTodayDeal: true },
    { name: 'Ragi Millet Flour', slug: 'ragi-millet-flour', description: 'Calcium-rich finger millet flour', categoryId: natural.id, subCategoryId: grains.id, brandId: farmFresh.id, productType: 'natural', productCategory: 'grains_rice', purchasePrice: 84, salesPrice: 140, quantityType: 'pack', rating: 4.5, reviewCount: 28, isPopular: true },
  ];
