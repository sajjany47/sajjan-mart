...
export function Header({ activeCategories }: { activeCategories: string[] }) {
  ...
  const nav = NAV.filter(
    (n) => !n.category || activeCategories.includes(n.category),
  );
      ...
      <div className="bg-primary text-primary-foreground">
        <div className="container-px mx-auto flex max-w-7xl items-center justify-center py-1.5 text-xs text-center font-medium overflow-hidden">
          ...
          <span className="font-bold text-amber-300">
            0% GST • 0 PLATFORM FEES • 0 HIDDEN CHARGES
          </span>
          <span className="mx-2 text-primary-foreground/40 font-light">|</span>
          <span className="truncate">
            🛕 Puja Samagri Ke Sath Pandit Ji Booking Included!
          </span>
        </div>
      </div>
            ...
            <DialogContent className="sm:max-w-[400px]">
              <DialogHeader>
                ...
                <DialogDescription className="text-xs">
                  Food items are delivered within a 6 km radius of our Kalighat
                  kitchen.
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-3">
                ...
                <div className="relative flex py-1 items-center">
                  ...
                  <span className="flex-shrink mx-3 text-[10px] text-muted-foreground uppercase tracking-wider">
                    or enter address
                  </span>
                  <div className="flex-grow border-t border-border"></div>
                </div>
                      ...
                      <div className="space-y-1.5 mt-1">
                        ...
                        <div className="rounded-md bg-emerald-500/10 border border-emerald-500/20 px-2.5 py-1.5">
                          <p className="text-[11px] text-emerald-700 dark:text-emerald-400 leading-relaxed">
                            ✅{" "}
                            <strong>
                              Natural Products, General &amp; Puja Samagri
                            </strong>{" "}
                            are available — no range limit.
                          </p>
                        </div>
                      </div>
                    )}
                ...
                <>
                  ...
                  <DropdownMenuItem asChild>
                    <Link href="/account">
                      ...
                      {role === "admin" ? "My Account" : "My Account"}
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                  ...
                  {role === "admin" && (
                    <DropdownMenuItem asChild>
                      <Link href="/admin">
                        <LayoutDashboard className="mr-2 h-4 w-4" /> Switch to
                        Admin
                      </Link>
                    </DropdownMenuItem>
                  )}
